...
<!-- 配置文件 -->
<script type="text/javascript" src="<?php echo $js_domain;?>/js/ueditor/ueditor.config.js?v=<?php echo $js_version;?>"></script>
<script type="text/javascript" src="<?php echo $js_domain;?>/js/ueditor/ueditor.all.js?v=<?php echo $js_version;?>"></script>
<script type="text/javascript" src="<?php echo $js_domain;?>/js/ueditor/lang/zh-cn/zh-cn.js?v=<?php echo $js_version;?>"></script>
