		...
		<div class="span12 well well-large form-horizontal bs-docs-example">
			<legend>编辑页面</legend>                      
		           ...
		           <div class="control-group">
		                ...
		                <div class="controls" style="margin-left:80px;">
		                  <textarea rows="2" id="cover" style="width:600px;" value="<?php echo $operation['cover'];?>"><?php echo $operation['cover'];?></textarea>
		                </div> 
		           </div>
		           ...
		           <div class="control-group">
		                ...
		                <div class="controls" style="margin-left:80px;">
		                  <textarea rows="2" id="link" style="width:600px;" value="<?php echo $operation['link'];?>"><?php echo $operation['link'];?></textarea>
		                </div> 
		           </div>
		           ...
		           <div class="control-group">
		                ...
		                <div class="controls" style="margin-left:80px;">
		                  <textarea rows="10" id="content" style="width:600px;"><?php echo $operation['content'];?></textarea>
		                </div>
		           </div>
