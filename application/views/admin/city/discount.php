...
<div class="input-prepend">
<a href="/admin/city/discount/?order=1&stime=<?php echo $stime;?>&etime=<?php echo $etime;?>" class="btn btn-large btn-primary" >按id排序</a>
<a href="/admin/city/discount/?order=2&stime=<?php echo $stime;?>&etime=<?php echo $etime;?>" class="btn btn-large btn-primary" >按点击从大到小</a> 
<a href="/admin/city/discount/?order=3&stime=<?php echo $stime;?>&etime=<?php echo $etime;?>" class="btn btn-large btn-primary" >按点击从小到大</a>
</div>
    </div>
 ...
 <thead>
  ...
  <tbody>
    ...
    <tr>
      ...
      <th><?php if($v['etime'] < $now )echo "过期"; else echo "未";?></th>
