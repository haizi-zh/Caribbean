<div class="container" style="margin-top:50px;">
	<div class="row-fluid">
		<div class="span12 well well-large form-horizontal bs-docs-example">
			<legend>添加商家(注意:添加商场后,请联系技术人员做路由变更,再把商场显示状态打开。)</legend>
           ...
           <div class="control-group">
            ...
            <button class="btn btn-large btn-primary" type="button" style="float:right;margin-right:100px;" onclick="add_shop();">添加商家</button>
	    </div>
	</div>
</div>