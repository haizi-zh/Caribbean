   <header class="topbar">
      <div class="left tl"><?php if($city_info):?><a class="icon icon_back" href="<?php echo view_tool::echo_isset($domain);?>/<?php echo $city_info['lower_name'];?>-shoppingtips/"></a><?php endif;?></div>
