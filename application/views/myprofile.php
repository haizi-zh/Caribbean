			...
			<div class="shop_wrap fl">
				...
				<div class="tab" id="tab_container">
					<div class="fr turn_page" id="page_container">
						<a class="turn_left" node-type="prev" action-type="changePage" href="javascript:void(0);" action-data="uid=<?php echo $user_info['uid'];?>&action=prev&type=myprofile"></a>
						<em><i node-type="show"><?php echo $page;?></i>/<i node-type="all"><?php echo $page_cnt;?></i></em>
						<a class="turn_right" node-type="next" action-type="changePage" href="javascript:void(0);" action-data="uid=<?php echo $user_info['uid'];?>&action=next&type=myprofile"></a>
					</div>
