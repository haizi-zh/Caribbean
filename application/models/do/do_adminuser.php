...
// INSERT INTO `cms_user` (`id`, `username`, `password`, `power`, `info`) VALUES (NULL, 'keven', MD5('keven'), '0', '');
// INSERT INTO `cms_user` (`id`, `username`, `password`, `power`, `info`) VALUES (NULL, 'cc', MD5('cc'), '0', '');
