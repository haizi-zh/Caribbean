...
(function () {
     ...
     */
    var URL;
    var img_bucketname = "zanbai";    //upyun图片空间名
    var file_bucketname = "zanbai";    //upyun文件空间名
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:"http://" + img_bucketname + ".b0.upaiyun.com/" 
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,filePath:"http://" + file_bucketname + ".b0.upaiyun.com/" 
