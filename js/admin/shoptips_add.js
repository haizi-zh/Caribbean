$.ready(function () {
    ...
    var RICHEDITORHTML = '' +
        ...
        var content_html = $('#my_content')[0].value;
        ...
        //var editor = UE.getEditor('container',{toolbars:[['fullscreen','removeformat', 'bold', 'italic', 'underline', 'strikethrough', 'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', 'indent', 'insertorderedlist', 'insertunorderedlist', 'insertimage']]})
        ...
        //    window.editor = K.create('#my_content');
       // });

        $('#save_shoptips').addEvent('click', function(){
        ...
        $('#add_shoptips').addEvent('click', function(){
            // if (window.uploadImgFlag) {
            //     return;
            // }
            save_shoptips(0);
        ...
        $('#spider_shoptips').addEvent('click', function(){
            // if (window.uploadImgFlag) {
            //     return;
            // }
            save_shoptips(3);
