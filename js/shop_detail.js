$.ready(function () {
   ...
   //}
    ...
    function showMore(e){
        ...
        $seeMore[0].innerHTML = '<a href="javascript:void(0);" class="linkb">收起</a>';
    ...
    function hideMore(e){
        $shopIntro.setStyle('height', '245px');
        $seeMore[0].innerHTML = '<a href="javascript:void(0);" class="linkb">更多</a>';
